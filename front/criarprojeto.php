...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <div class="">
            <h1 class="text-center">Criar Projeto</h1>
            <hr>
            <p class="text-center text-warning col-lg-12">
                <?php
                if(isset($_SESSION['projectCreateError'])){
                    echo $_SESSION['projectCreateError'];
                    unset($_SESSION['projectCreateError']);
                }
                ?>
            </p>
            <form class="col-lg-offset-4 col-lg-4 col-lg-offset-4" method="post" action="../back/incluir/createproject.php">
                <div class="form-group">
                    <label for="projeto">Projeto</label>
                    <input type="text" class="form-control" id="projeto" name="project">
                </div>
