...
<div class="container">
    <div class="row text-right">
        <a href="criarempresa.php" class="btn btn-info btn-md"><i class="fa fa-plus fa-lg" aria-hidden="true"></i></a>
    </div>
    <h1 class="text-center">Listar Empresas</h1>
    <hr>
    <?php
    $resultado = mysqli_query($conn, "SELECT * FROM companies ORDER BY id");
